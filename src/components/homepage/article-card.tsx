...
export function ArticleCard({ article }: { article: Article }) {
  ...
  return (
    <article className="market-floating-card flex h-full flex-col overflow-hidden rounded-[24px] border border-cyan-400/40 bg-gradient-to-br from-white via-white to-sky-50 shadow-[0_16px_40px_rgba(11,79,122,0.12)]">
      ...
      <div className="flex flex-1 flex-col space-y-3 p-4 sm:space-y-4 sm:p-6">
        ...
        <h3 className="text-lg font-semibold text-[#0B3A6E] sm:text-xl">{title}</h3>
