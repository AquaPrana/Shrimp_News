...
//import { LiveMarketDashboard } from "@/components/homepage/live-market-dashboard";
...
export function HomePage() {
  ...
  const farmingArticles = launchArticles
    .filter((article) =>
      article.topics.some(
        (topic) =>
  ...
  return (
    <div className="min-h-full overflow-hidden bg-white">
      ...
      <section className="relative overflow-hidden bg-white px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div className="home-reveal relative z-10 mx-auto grid max-w-[1340px] gap-14" style={{ animationDelay: "0.12s" }}>
      ...
      {/* <div className="home-reveal" style={{ animationDelay: "0.08s" }}>
        <LiveMarketDashboard />
      </div> */}
