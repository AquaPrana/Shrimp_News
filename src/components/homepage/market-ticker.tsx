...
function formatPrice(value: number, currency: string, unit: string) {
  ...
  if (unit === "kg") {
    return `${currencySymbol}${priceValue}/kg`;
  }

  if (unit === "MT") {
    return `${currencySymbol}${priceValue} MT`;
  }
...
export function MarketTicker() {
  ...
  return (
    <section
      ...
      aria-label="Shrimp market ticker"
    >
      <div className="relative h-[30px] overflow-hidden sm:h-[32px]">
        <div
          ...
          role="list"
          aria-label="Market price updates"
        >
          {isLoading &&
            tickerItems.length === 0 &&
              ...
              return (
                ...
                >
                  ...
                  <span
                    ...
                    aria-label={`${item.direction} change`}
                  >
                    {changeLabel ?? "—"}
                  </span>
