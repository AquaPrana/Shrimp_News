...
const socialPlatforms = [
  { name: "Facebook", href: "https://www.facebook.com/profile.php?id=61580776233747", icon: FaFacebookF },
  { name: "Instagram", href: "https://www.instagram.com/shrimpnewsenglish?igsh=MWg5ZmpvdzZ3bmo4cg==", icon: FaInstagram },
  { name: "X", href: "https://x.com/Shrimp_News", icon: FaXTwitter },
  { name: "LinkedIn", href: "https://www.linkedin.com/company/shrimpnews/", icon: FaLinkedinIn },
  { name: "YouTube", href: "https://www.youtube.com/@ShrimpNewsEnglish", icon: FaYoutube },
] as const;
              ...
              {socialPlatforms.map((platform) => {
                ...
                return (
                  <a
                    ...
                    aria-label={`Open ${t("shrimpNews")} ${platform.name}`}
